  ...
  return (
    <DashboardLayout>
      ...
      <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
        <span className="font-mono text-6xl font-bold tracking-tight text-gray-300 sm:text-7xl">404</span>
        <h1 className="mt-4 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Trang không tồn tại</h1>
