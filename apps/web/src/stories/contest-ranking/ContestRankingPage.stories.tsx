...
const MOCK_PROBLEM_LABELS = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'];
...
const RUNNING_RANKINGS: Ranking[] = [
  {
    ...
    details: [
      ...
      { problem_id: '9', problem_position: 9, submission_count: 2, score: 0, last_submit: '2026-08-17T15:40:00Z' },
  ...
  },
  {
    ...
    details: [
      ...
      { problem_id: '8', problem_position: 8, submission_count: 1, score: 0, last_submit: '2026-08-17T15:35:00Z' },
  ...
  },
  {
    ...
    details: [
      ...
      { problem_id: '6', problem_position: 6, submission_count: 1, score: 1, last_submit: '2026-08-17T15:40:00Z' },
      { problem_id: '7', problem_position: 7, submission_count: 2, score: 0, last_submit: '2026-08-17T15:45:00Z' },
  ...
  },
  {
    ...
    details: [
      ...
      { problem_id: '6', problem_position: 6, submission_count: 1, score: 0, last_submit: '2026-08-17T16:00:00Z' },
  ...
  },
  {
    ...
    details: [
      ...
      { problem_id: '5', problem_position: 5, submission_count: 0, score: 0, last_submit: '' },
...
const mockAuthValue: AuthContextValue = {
  ...
  setAccessToken: () => {},
  completeLogin: async () => {},
  user: { name: 'Team 3', email: 'team3@fcode.club', role: 'contestant' },
  isAuthReady: true,
  isLoggedIn: true,
};
...
const createSimSteps = (): Ranking[][] => {
  ...
  if (t2) {
    ...
    t2.penalty = 145;
    t2.details = [
      ...t2.details.filter((d: RankingDetail) => d.problem_position !== 8),
      { problem_id: '8', problem_position: 8, score: 2, submission_count: 2, last_submit: new Date().toISOString() },
    ];
  }
